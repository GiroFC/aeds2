...
public class TP04Q09 {
    public static void main(String[] args) {
        try {
            ...
            comandoaux = sc.nextLine();
            char comando = comandoaux.charAt(0);
            char caractere = comandoaux.charAt(2);
            arvore.inserir(caractere);
            while(sc.hasNext()){
                comandoaux = sc.nextLine();
                if(comandoaux.equals("INFIXA")){
                    arvore.caminharCentral();
                    System.out.println("");
                }else if(comandoaux.equals("PREFIXA")){
                    arvore.caminharPre();
                    System.out.println("");
                }else if(comandoaux.equals("POSFIXA")){
                    arvore.caminharPos();
                    System.out.println("");
                }else if(comandoaux.charAt(0) == 'I'){
                    arvore.inserir(comandoaux.charAt(2));
                }else if(comandoaux.charAt(0) == 'P'){
                    if(arvore.pesquisar(comandoaux.charAt(2)) == true){
                        System.out.print(comandoaux.charAt(2));
                        System.out.println(" existe");
                    }else if(arvore.pesquisar(comandoaux.charAt(2)) == false){
