...
class TP01Q08 {
    ...
    public static void Contador(String html, String titulo) {
        ...
        System.out.println("a(" + (qtd[0]) + ") e(" + (qtd[1]) + ") i(" + qtd[2] + ") o(" + qtd[3] + ") u(" + qtd[4]
                ...
                + (char) '\u00E0' + "(" + qtd[10] + ") " + (char) '\u00E8' + "(" + qtd[11] + ") " + (char) '\u00EC'
                + "(" + qtd[12] + ") " + (char) '\u00F2' + "(" + qtd[13] + ") " + (char) '\u00F9' + "(" + qtd[14] + ") "
                + (char) '\u00E3' + "(" + qtd[15] + ") " + (char) '\u00F5' + "(" + qtd[16] + ") " + (char) '\u00E2'
                + "(" + qtd[17] + ") " + (char) '\u00EA' + "(" + qtd[18] + ") " + (char) '\u00EE' + "(" + qtd[19] + ") "
                + (char) '\u00F4' + "(" + qtd[20] + ") " + (char) '\u00FB' + "(" + qtd[21] + ") consoante(" + qtd[22]
                + ") <br>(" + qtd[23] + ") <table>(" + qtd[24] + ") " + titulo);
    }
